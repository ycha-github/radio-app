  ...
  return (
      <>
        <Stack direction="row" spacing={1} marginBottom={2}>
            <Button onClick={onOpenModal1} color={props.color} variant="outlined" startIcon={<AddCircleOutlineOutlined />}>
                Nuevo
            </Button>
        </Stack>
        <ModalRadio  className='modal2' isOpen={isOpen1} onCloseModal={onCloseModal1}>
