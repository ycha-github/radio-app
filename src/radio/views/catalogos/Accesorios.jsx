...
const columns =  [
  ...
  { field: 'serie_bateria', valueGetter: ({ value }) => value==="" ? " ----- " : value===null ? " ----- " : value=value, headerClassName: "super", headerName: 'Serie Batería',flex: 1 , minWidth: 150 },
  { field: 'serie_cargador', valueGetter: ({ value }) => value==="" ? " ----- " : value===null ? " ----- " : value=value, headerClassName: "super", headerName: 'Serie Cargador',flex: 1 , minWidth: 150 },
  { field: 'serie_gps', valueGetter: ({ value }) => value==="" ? " ----- " : value===null ? " ----- " : value=value, headerClassName: "super", headerName: 'Serie GPS',flex: 1 , minWidth: 150 },
  { field: 'nombreMarcas',headerClassName: "super", headerName: 'Marca', flex: 1, minWidth: 130 },
  { field: 'nombreModelos',headerClassName: "super", headerName: 'Modelo', flex: 1, minWidth: 130 },
